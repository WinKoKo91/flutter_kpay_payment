...
class FlutterKpayPayment {

  static const MethodChannel _channel = const MethodChannel('flutter_kpay_payment');
  static const EventChannel _eventChannel =
  const EventChannel('flutter_kpay_payment/pay_status');
