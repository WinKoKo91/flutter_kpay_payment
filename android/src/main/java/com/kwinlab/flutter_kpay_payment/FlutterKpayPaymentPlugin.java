package com.kwinlab.flutter_kpay_payment;
...
/** UntitledPlugin */
public class FlutterKpayPaymentPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  private static final String CHANNEL = "flutter_kpay_payment";
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    final EventChannel eventchannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(),
            "flutter_kpay_payment/pay_status");
